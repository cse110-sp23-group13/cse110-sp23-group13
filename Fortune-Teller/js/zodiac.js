...
/**
 * Preloads the images on initialization to improve performance.
 * Iterates over the array of zodiac names and creates a new Image object for each one, setting its src property to the path.
 */
function init() {
  // Preload stars and symbols
  for (var i = 0; i < zodiacSigns.length-1; i++) {
    var img1 = new Image();
    img1.src = `./images/signs/${zodiacSigns[i].name}.png`
    var img2 = new Image();
    img2.src = `./images/stars/${zodiacSigns[i].name}.png`
}
};
